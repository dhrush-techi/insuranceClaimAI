...
class CaseRecord:
    ...
    # ---- New: rich artifacts for traceability / novelty ----
...
def load_all_cases_from_disk() -> None:
    for path in CASE_DIR.glob("*.json"):
        ...
        # Allow backward compatibility – ignore unknown keys
        case = CaseRecord(
            id=data["id"],
...
# ---- Feedback storage (for active learning hook) -----------------------
